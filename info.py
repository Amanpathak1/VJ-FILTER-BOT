...
API_ID = int(environ.get('API_ID', '22253680'))
API_HASH = environ.get('API_HASH', '4fc4c646519fe43891bebd1449744b7e')
BOT_TOKEN = environ.get('BOT_TOKEN', "7140690982:AAHKm-LEVPKvh2OildpA-zWQTULKbiCGUDU")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6352927253').split()]
